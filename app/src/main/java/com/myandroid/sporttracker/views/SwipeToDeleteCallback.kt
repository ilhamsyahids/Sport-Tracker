package com.myandroid.sporttracker.views
...
class SwipeToDeleteCallback(private val mReminderListAdapter: ReminderAdapter) : ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT or ItemTouchHelper.RIGHT) {
